  ...
  webSocket.onmessage = function onMessage(message) {
    try {
      ...
      if (existingDeviceData) {
        ...
        newDeviceData.addData(messageData.MessageDate, messageData.IotData.CO2, messageData.IotData.CO, messageData.IotData.NO2, messageData.IotData.O3, messageData.IotData.PM10, messageData.IotData.PM25, messageData.IotData.VOC);
